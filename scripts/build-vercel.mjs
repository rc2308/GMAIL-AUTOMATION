...
for(const name of ['api','cloud','public-pages','server.mjs','sheet-import.mjs','auth.mjs','core.js','model-picker.js','app.js','auth.js','index.html','auth.html','styles.css','package.json','node_modules'])cpSync(name,join(destination,name),{recursive:true});
